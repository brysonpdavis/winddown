...
genre_dict = {"action": 28, "adventure": 12, "documentary": 99, "drama": 18, "history": 36, "horror": 27, "music": 10402, "romance": 10749, "science": 878, "war": 10752}
...
def getGenres(given_text):
    ...
    profile = personality_insights.profile(
            movie_script, content_type='text/plain',
...
genres = getGenres("movie_script.txt")
print(getMovies(genres))
